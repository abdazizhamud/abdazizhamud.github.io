...
<body>
    ...
    <div class="table-container">
        <div class="title-section">
            ...
            <?php if ($_SESSION["level"] === "admin"): // Only show for admin ?>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-button-group">
                            <?php if ($_SESSION["level"] === "admin"): // Show only for admin ?>
                            ...
                            <?php else: ?>
                                <span class="text-muted">No action available</span> <!-- Placeholder for regular users -->
                            <?php endif; ?>
                        </div>
                    </td>
                </tr>
